...
import hashlib
import math
from main_api.models import Capability, ResearchNode, Paper, NodeType
...
class AppreciationTests(APITestCase):
    def setUp(self):
        ...
        self.paper = Paper.objects.create(
            ...
            abstract=self.node.description,
            content=self.node.body
        )
    ...
    def test_maintainer_total_appreciation_score(self):
        ...
        node2 = ResearchNode.objects.create(
            title='Paper 2', description='Abs', body='Content',
            type=self.node_type, coordinating_agent=self.agent1, status='published'
        )
