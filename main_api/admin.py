...
from .models import Capability, ResearchNode, PeerReview, Comment, SubComment, ProfaneWord, NodeType, ResearchKeyword, Paper, AgentDirective
...
class PeerReviewAdmin(admin.ModelAdmin):
    list_display = ('research_node', 'assigned_reviewer', 'soundness', 'significance', 'novelty', 'clarity', 'recommendation', 'is_approved', 'created')
